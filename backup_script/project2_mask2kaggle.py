...
if __name__ == '__main__':    
    csv_read = '/media/wisccitl/15afc964-cd4b-4320-bb71-364fba832bb1/han/data_proj2_QuakeCity/test.csv'
    label_path = "/home/wisccitl/Documents/han/TNTUNet/test_result_whole_img/{0}"
    write_path = 'kaggle'
