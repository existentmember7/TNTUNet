...
class Option():
    def __init__(self):
        ...
        self.parser.add_argument('--training_data_path', default='D:\\han\\KITTI_new\\small_dataset\\train',type=str, help="training data file path")
        self.parser.add_argument('--testing_data_path', type=str, default="D:\\han\\KITTI_new\\small_dataset\\val",help="testing data file path")
        self.parser.add_argument('--validating_data_path', type=str, default="D:\\han\\KITTI_new\\small_dataset\\val",help="validating data file path")
        ...
        self.parser.add_argument("--num_classes", type=int, default=6, help="the number of classes")
        ...
        self.parser.add_argument("--model_path", type=str, default="C:\\Users\\whan59\\Desktop\\TNTUNet\\model", help="the path of saving logs")
        self.parser.add_argument("--model_weight_path", type=str, default="/home/wisccitl/Documents/han/TNTUNet/model/epoch_4.pth", help="the path of saving weights")
