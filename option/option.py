...
class Option():
    def __init__(self):
        ...
        self.parser.add_argument('--training_data_path', default='/Users/hanwei/Desktop/transformer-in-transformer/datasets/train/',type=str, help="training data file path")
        ...
        self.parser.add_argument("--image_height", type=int, default=1280, help="size of image height") #720
        self.parser.add_argument("--image_width", type=int, default=1280, help="size of image width")
        self.parser.add_argument("--channels", type=int, default=4, help="number of image channels")
        self.parser.add_argument("--batch_size", type=int, default=2, help="batch size of training process")
