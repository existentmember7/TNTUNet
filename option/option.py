...
class Option():
    def __init__(self):
        ...
        self.parser.add_argument("--num_classes", type=int, default=273, help="the number of classes")
        ...
        self.parser.add_argument("--save_interval", type=int, default=1, help="the model weights saving interval")
        self.parser.add_argument("--model_path", type=str, default="/home/wisccitl/Documents/han/TNTUNet/model/", help="the path of saving logs")
